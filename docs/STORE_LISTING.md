...
Affiche l'heure estimee de fin dans les lecteurs YouTube, Netflix et Prime Video.
...
Sur YouTube, Netflix et Prime Video, le badge est integre directement aux controles du lecteur quand une zone de controle fiable est detectee.
...
L'extension s'execute uniquement sur YouTube, Netflix et Prime Video/Amazon Video afin d'ajouter le badge de fin estimee. Elle ne lit pas l'historique, ne collecte pas de donnees et ne contacte aucun serveur externe.

## Notes pour la suite

L'architecture reste preparee pour ajouter d'autres plateformes video plus tard. Disney+ est a venir, avec une integration native uniquement si elle est stable.
